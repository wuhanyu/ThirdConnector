 ...
 * 2014-01-02T16:03:05.987+08:00
 * Generated source version: 3.0.0-milestone1
 * 
 */
@WebServiceClient(name = "ServiceImpl", 
                  wsdlLocation = "http://192.168.12.35:8087/bugReqRel?wsdl",
...
public class ServiceImpl extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.12.35:8087/bugReqRel?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ServiceImpl.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.12.35:8087/bugReqRel?wsdl");
        }
        WSDL_LOCATION = url;
    }
